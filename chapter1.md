...
* min(data): the minimum value will be returned (what is the min value).
* which.min(data): the entry with the minimum value will be returned (which one has the minimum).
